...
export function HomeButton() {
  return (
    <Pressable onPress={() => router.navigate('/')} hitSlop={12} style={styles.homeBtn}>
...
export function ScreenHeader({ title, showInfo, showLang, onTitleLongPress }: ScreenHeaderProps) {
  ...
  const infoBtn = showInfo ? (
    <Pressable onPress={() => router.push('/info')} hitSlop={12} style={styles.infoBtn}>
